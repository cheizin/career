...
<section class="padd-top-80 padd-bot-80">
  <div class="container">
    <div class="row">
      ...
      <li class="nav-item">
        <a class="nav-link" data-toggle="tab" href="#profile"><i class="login-icon ti-user"></i>View Profile</a>
      </li>
<input type="hidden" name="email" class="email" value="<?php echo $_SESSION['email'];?>">
      <li class="nav-item">
    								...
    								<li class="nav-item">
    									<a class="nav-link" data-toggle="tab" href="#applied"><i class="ti-file"></i>Applied jobs</a>
    								</li>
    								<li class="nav-item">
    									<a class="nav-link" data-toggle="tab" href="#alert"><i class="ti-file"></i>Alert job</a>
    								</li>
    								<li class="nav-item">
    									<a class="nav-link" data-toggle="tab" href="#cv"><i class="ti-file"></i>CV & Cover Letter</a>
    								</li>
      ...
      <div class="profile_detail_block">
  			<div class="col-md-6 col-sm-6 col-xs-12">
  			  <div class="form-group">
  				...
  				<input type="text" class="form-control" value ="<?php echo $profile_pic['fName'];?>"  >
  			  </div>
  			</div>
  			<div class="col-md-6 col-sm-6 col-xs-12">
  			  <div class="form-group">
  				<label>Last Name</label>
  				<input type="text" class="form-control" value ="<?php echo $profile_pic['lName'];?>"  >
  			  </div>
  			</div>
  			<div class="col-md-6 col-sm-6 col-xs-12">
  			  <div class="form-group">
  				<label>Email</label>
  				<input type="text" class="form-control" value ="<?php echo $profile_pic['Email'];?>"  >
  			  </div>
  			</div>
  			...
  			<div class="col-md-6 col-sm-6 col-xs-12">
  			  <div class="form-group">
  				<label>Contact</label>
  				<input type="text" class="form-control" value ="<?php echo $profile_pic['contact'];?>"  >
  			  </div>
  			</div>
  			<div class="col-md-6 col-sm-6 col-xs-12">
  			  <div class="form-group">
  				<label>Location</label>
  				<input type="text" class="form-control" value ="<?php echo $profile_pic['location'];?>"  >
  			  </div>
  			</div>
        <div class="col-md-6 col-sm-6 col-xs-12">
  			  <div class="form-group">
  				<label>Nationality</label>
  				<input type="text" class="form-control" value ="<?php echo $profile_pic['nationality'];?>"  >
  			  </div>
  			</div>
        <div class="col-md-6 col-sm-6 col-xs-12">
          <div class="form-group">
          <label>Access Level</label>
          <input type="text" class="form-control" value ="<?php echo $profile_pic['access_level'];?>" readonly >
          </div>
        </div>
           ...
           <tr style="cursor: pointer;">
             ...
             <td>
               ...
               <td>
                 ...
                 <form method="post" action="reviewedTest.php">

                    <input type="hidden" name="job_posting_id" value="<?php echo $row['job_posting_id'];?>">

                             <div class="vertical-job-body">
                   <div class="row">
                     <div class="col-md-9 col-sm-12 col-xs-12">
Click on the status Name for more details
                     </div>
                      </div>
                       </div>
                 <div class="job-verticle-list">
  ...
  <?php
      ...
      if(mysqli_num_rows($result))
      {
        ...
        {
          ?>
     <input type="hidden" name="reference_no" value="<?php echo $profile_pic['reference_no'];?>">
<input type="submit" name="submit" class="btn btn-info" value="<?php echo $profile_pic['status_name'];?>" title="Click Here to view more details and Apply">
