                 ...
                 <?php
                   $no2 = 1;
                                  ...
                                  while($row3 = mysqli_fetch_array($sql_query3))
                                  {
                                    ...
                                    <li> <a href="https://www.cma.or.ke/index.php?option=com_content&amp;view=article&amp;id=435:capital-markets-soundness-report-volume-vi-quarter-1-2018&amp;catid=12:press-center&amp;Itemid=207#" target="_blank"><i>News and Highlights </i></a> &#8211; This is a link from Capital Markets Authority with current news and highlights regarding the market.

                                    </li><p>



                                    <li> <a href="https://portal.cma.or.ke/" target="_blank"><i>Online Services Portal </i></a> &#8211; This is a link from Capital Markets Authority with a variety of services available through the portal i.e. Application and renewal of licensing, Approvals, reporting obligations, no objection requests and how to update details.

                                    </li><p>

                                    <li> <a href="https://www.cma.or.ke/index.php?option=com_phocadownload&amp;view=category&amp;id=7&amp;Itemid=199" target="_blank"><i>Circulars </i></a> &#8211; This includes a link from the Capital Markets Authority with different circulars.
          ...
          <div class="card">
            ...
            <div class="card-header" role="tab" id="heading2">
              <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" href="#collapse2"
                aria-expanded="false" aria-controls="collapseTwo2">
                <h4 class="mb-0">
                  B) TOOLS TO GET STARTED; THE ABC OF INVESTING WITHIN CAPITAL MARKETS: <i class="fas fa-angle-down rotate-icon"></i>
                </h4>
              </a>
            </div>
            ...
            <div id="collapse2" class="collapse" role="tabpanel" aria-labelledby="heading2" data-parent="#accordionEx">
              <div class="card-body">
                      ...
                      <p>This tool will guide you on how to open a CDS account, make an order for trade,
                         know your rights and responsibilities as an investor and the frequently asked questions on investments among others.</p>
                <ol><p>



                <li> <a href="https://www.cma.or.ke/index.php?option=com_phocadownload&amp;view=category&amp;download=140:cma-handbook-complete&amp;id=45:information-for-investors&amp;Itemid=222" target="_blank"><i>CMA Hand Book </i></a>

                &#8211; This is a link to the Capital Markets CMA handbook which attempts to define in simple terms some of the capital markets concepts and procedures with a view to giving the reader an easy and enjoyable readership. </li><p>
