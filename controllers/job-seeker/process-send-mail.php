...
$email = $_SESSION['email'];
  ...
  //  $mail->SMTPAuth   = true;                                   // Enable SMTP authentication
    ...
    $mail->addAddress("$email", 'Potential Staffing Assessment Added');     // Add a recipient
...
$mail->Subject = 'Potential Satffing Career Portal Assessment';
$mail->Body    = "Dear <b>.$email.</b>, <br/><br/><br/>

The Asessement Name:- <b>".$job_title."</b><br/>
was added in the system by: <b>".$email."</b><br/>
<br/>
<br/><br/><br/>
Please log in to <a href='https://career.panoramaengineering.com/'>Career Portal</a> to view Details.
<br/><br/><br/><br/><br/>
