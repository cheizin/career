...
// email Marketing job seeker

$(document).on("submit","#bulk-email-form1", function(e){
    e.preventDefault();
    var btn = document.querySelector('.submitting');
// Add the .disabled class
btn.classList.add('disabled');
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            if(data == 'success')
            {
              Toast.fire({
                 icon: 'success',
                 title: 'Mail Sent Successfully to Job-seeker '
                });
  window.location.href = "bulk_mails.php";
    // Restore the button text
    btn.textContent = btn.getAttribute('data-original');
...
btn.removeAttribute('data-original');
                ...
                $.ajax({
                  data : $('#bulk-email-form1').serializeArray(),
                  type: "post",
                  url: "controllers/mailingSystem/bulk_mailing1.php",
                  success: function (mail_data) {
                      console.log(mail_data);
                  }
              });
...
// email Marketing individual

$(document).on("submit","#bulk-email-form2", function(e){
    e.preventDefault();
    var btn = document.querySelector('.submitting');
// Add the .disabled class
btn.classList.add('disabled');
...
btn.removeAttribute('data-original');
                ...
                $.ajax({
                  data : $('#bulk-email-form2').serializeArray(),
                  type: "post",
                  url: "controllers/mailingSystem/bulk_mailing2.php",
                  success: function (mail_data) {
                      console.log(mail_data);
                  }
              });
...
//post job vaccancy
$(document).on("submit","#add-resource-header-form", function(e){
    e.preventDefault();
    var btn = document.querySelector('.submitting');
...
// Update the button text
btn.textContent = 'Submitting Resource Details...';
    var form_data = $(this).serializeArray();
    var form_url = 'controllers/job-posting/job_vaccancy_controller.php';
    var form_method = 'POST';
...
$(document).on("submit","#add-header-form", function(e){
    e.preventDefault();
    var btn = document.querySelector('.submitting');
...
// Update the button text
btn.textContent = 'Submitting Resource Header Details...';
    var form_data = $(this).serializeArray();
    var form_url = 'controllers/job-posting/job_vaccancy_controller.php';
    var form_method = 'POST';
    ...
    $.ajax({
        ...
        success:function(data){
            ...
            if(data == 'success')
            {
              Toast.fire({
                 icon: 'success',
                 title: 'Resource Header Saved Successfully'
                });
...
function Modifyresource(str)
{

    var form_id = $('#edit-resource-form-'+str);
    ...
    form_data.append('edit_resource',edit_resource);

    var form_url = 'controllers/edit/resourceEditController.php';
    var form_method = 'POST';
        ...
        success:function(data){
            ...
            if(data == 'success')
            {
              ...
              $('.modal-backdrop').remove();
               ...
               Toast.fire({
                    icon: 'success',
                    title: 'Resource Modified Successfully'
                  });
...
function Modifyresource2(str)
{

    var form_id = $('#edit-resource2-form-'+str);
    ...
    var resource2 = $('#resource2-'+str).val();

    var edit_resource2 = 'edit_resource2';

    //var form_data = new FormData();
    var form_data = new FormData($(form_id)[0]);//$(this).serializeArray();

    form_data.append('resource2', resource2);
    form_data.append('edit_resource2',edit_resource2);
        ...
        success:function(data){
            ...
            if(data == 'success')
            {
              ...
              $('.modal-backdrop').remove();
               ...
               Toast.fire({
                    icon: 'success',
                    title: 'Resource Header  Modified Successfully'
                  });
...
//start close question
function CloseResources(id) {

  Swal.fire({
      title: 'This Resource will be removed from the list',
      text: "Are you sure to proceed?",
      icon: 'Resource',
      showCancelButton: true,
      confirmButtonText: 'YES, Delete',
      ...
      if (result.value) {
        ...
        var close_resource = 'close_resource';
        var form_data = {
          id:id,
          close_resource:close_resource
        };
        var form_url = 'controllers/delete/deleteResourceController.php';
        var form_method = 'POST';
...
//start close question
function CloseResources2(id) {

  Swal.fire({
      title: 'This Resource Header with Resource details will be removed from the list',
      text: "Are you sure to proceed?",
      icon: 'Resource',
      showCancelButton: true,
      confirmButtonText: 'YES, Delete',
      ...
      if (result.value) {
        ...
        var close_resource2 = 'close_resource2';
        var form_data = {
          id:id,
          close_resource2:close_resource2
        };
        var form_url = 'controllers/delete/deleteResourceController.php';
        var form_method = 'POST';
