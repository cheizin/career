...
if($_SERVER['REQUEST_METHOD'] == 'POST')
{
 ...
 if(mysqli_commit($dbc))
 {
  ...
  else if(isset($_POST['close_resource']))
  {
    /* set autocommit to off */
    mysqli_autocommit($dbc, FALSE);
  ...
  //  $project_id = $project_id['project_id'];
    ...
    mysqli_query($dbc,"DELETE FROM resource_details WHERE id ='".$id."'");


    //log the action
    $action_reference = "Deleted the Resources with id " . $id['id'];
  ...
  //end close project
    ...
    else if(isset($_POST['close_resource2']))
    {
      /* set autocommit to off */
      mysqli_autocommit($dbc, FALSE);
    ...
    //  $project_id = $project_id['project_id'];
      ...
      mysqli_query($dbc,"DELETE FROM resources_header WHERE id ='".$id."'");
  ...
  //  $project_id = $project_id['project_id'];
    ...
    mysqli_query($dbc,"DELETE FROM job_posting WHERE id ='".$id."'");
