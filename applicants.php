...
require_once("controllers/auth/auth.php");
        ...
        if(!isset($_SESSION['email']) && empty($_SESSION['email'])) {
           echo 'Kindly Login First or signup to access the Applicants';
...
<div class="page-title">
  <div class="container">
    <div class="page-caption">
      ...
      <p><a href="#" title="Home">Home</a> <i class="ti-angle-double-right"></i> View Applicants</p>
    </div>
  </div>
</div>
<!-- ======================= End Page Title ===================== -->
      ...
      $sql = mysqli_query($dbc,"SELECT * FROM job_posting  WHERE email ='".$_SESSION['email']."' ORDER BY id DESC");
       ...
       <tr style="cursor: pointer;">
         ...
         <td>
           ...
           <div class="job-verticle-list">
             <div class="vertical-job-card">
               <div class="vertical-job-header" onclick="viewJobApplicants('<?php echo $row['id'];?>');">
                 ...
                 <h4>   <input type="submit" name="submit" class="btn btn-info" value="<?php echo $row['job_title'] ;?>" title="Click Here to view applicants"></h4>
           ...
           <td>
             <form method="post" action="job-seeker.php">
             <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
