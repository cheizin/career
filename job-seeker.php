...
<section class="padd-top-80 padd-bot-80">
  <div class="container">
            ...
            <tr style="cursor: pointer;">
              ...
              <td width="50px"> <?php echo $no++;?>.
                        ...
                        <td  onclick="SelectProjectModule('<?php echo $row['id'];?>')">
                              ...
                              <td class="btn btn-link" data-toggle="modal" data-target="#skills-modall-<?php echo $row['id'];?>"title="Click <?php echo $employment['job_title'];?> to view more Details">
                                <?php
   ...
   <div class="modal-dialog modal-lg modal-dialog-scrollablle" role="document">
     <div class="modal-content">

       <div class="modal-header alert alert-success">

         <h5 class="modal-title">Details for <strong> : <?php echo $row['applicant_email'];?>
            <span class="font-weight-bold"></h5>
         <button type="button"  aria-label="Close" >
           <span aria-hidden="true">Click here to Close Window</span>
         </button>
       </div>
       <div class="modal-body">
         ...
         <div class="row">
           <div class="col-md-3">
             ...
             $sql_query1 =  mysqli_query($dbc,"SELECT * FROM selected_job_skills WHERE email ='".$row['applicant_email']."' ");
             $number = 1;
             if($total_rows1 = mysqli_num_rows($sql_query1) > 0)
             {?>
             ...
             <?php
             $no = 1;
             $sql2= mysqli_query($dbc,"SELECT * FROM selected_job_skills WHERE email ='".$row['applicant_email']."' ");
          ...
          No Skills</p>
           ...
           <div class="col-md-3">
             ...
             $sql_query1 =  mysqli_query($dbc,"SELECT * FROM selected_competencies WHERE email ='".$row['applicant_email']."' ");
             $number = 1;
             if($total_rows1 = mysqli_num_rows($sql_query1) > 0)
             {?>
            ...
            <table id="example" class="table table-striped table-bordered" style="width:100%">
             ...
             <?php
             $no = 1;
             $sql2= mysqli_query($dbc,"SELECT * FROM selected_competencies WHERE email ='".$row['applicant_email']."' ");
             while($awards = mysqli_fetch_array($sql2))
             {
             ?>
             <tr style="cursor: pointer;">
  ...
  <table id="example" class="table table-striped table-bordered" style="width:100%">
             ...
             <?php
             $no = 1;
             $sql2= mysqli_query($dbc,"SELECT * FROM selected_kpi WHERE email ='".$row['applicant_email']."' ");
             while($awards = mysqli_fetch_array($sql2))
             {
             ?>
             <tr style="cursor: pointer;">
