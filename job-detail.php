...
$job_post = mysqli_fetch_array(mysqli_query($dbc,"SELECT * FROM job_posting WHERE id ='".$_POST['id']."'"));
 ...
 $sql_query123 =  mysqli_query($dbc,"SELECT * FROM applied_jobs WHERE job_posting_id ='".$job_post['id']."' && applicant_email ='".$_SESSION['email']."'");

$company_details = mysqli_fetch_array(mysqli_query($dbc,"SELECT * FROM staff_users WHERE Email ='".$job_post['email']."'"));
?>
<!DOCTYPE html>
<html class="no-js" lang="zxx">
<!-- Mirrored from utouchdesign.com/themes/envato/escort/job-detail.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 11 Feb 2021 07:04:47 GMT -->
<head>
  <?php
