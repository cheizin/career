...
?>
           ...
           <div class="card">
<!-- Card header -->
<div class="card-header" role="tab" id="<?php echo $row['id'];?>">
...
<div id="<?php echo $row['id'];?>" class="collapse" role="tabpanel" aria-labelledby="headingTwo2" data-parent="#accordionEx">
  <div class="card-body">
<?php
  $no2 = 1;
                 ...
                 while($row3 = mysqli_fetch_array($sql_query3))
                 {
                   ...
                   <!-- Card body -->
                       ...
                       <td width="40px"><?php echo $no2++ ;?>.

                       </td>


                       <td><?php echo $row3['resource'];?></td>


                       <td>
                         <button type="button" class="btn btn-link" data-toggle="modal" data-target="#edit-project-modal-<?php echo $row3['id'];?>">
                          Edit
                        </button>


                        <!-- edit project modal -->
                        <div class="modal fade" id="edit-project-modal-<?php echo $row3['id'];?>">
                       ...
                       <td>
                       <a href="#" class="btn btn-link" onclick="CloseProject('<?php echo $row3['id'];?>');">
                         Delete
                       </a>
                     </td>
