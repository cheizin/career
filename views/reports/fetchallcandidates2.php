                                        ...
                                        <tr>
                                          <td>#</td>
                                            <td width"70">Candidate Details</td>
                                                <td width"70">Skills,Kpi,Competency</td>
                 ...
                 ?></span>
                           ...
                           <?php
                                  ...
                                  Holds a    <?php
                                         ...
                                         <?php
                                              ...
                                              <td>
                                               ...
                                               <strong>   <span class="pull-left vacancy-no">        Key Competenecies     <br/>               <strong>
                             <?php

                                  $result = mysqli_query($dbc, "SELECT * FROM selected_competencies WHERE email ='".$row['email']."'"  );
                                  if(mysqli_num_rows($result))
                                  {
                                    while($project= mysqli_fetch_array($result))
                                    {
                                        echo $project['competency_name'];
                                    ...
                                    ?>
                                              ...
                                              <div class="alert alert-success">
                                                ...
                                                <i class="fa fa-plus-circle"></i> No competency added</p>

                                              </div>
                                              <?php
                                  }
                                  ?>   <br/>   Key Skills        <br/>  <strong>
                             <?php

                                  $result = mysqli_query($dbc, "SELECT * FROM selected_job_skills WHERE email ='".$row['email']."'"  );
                                  if(mysqli_num_rows($result))
                                  {
                                    while($project= mysqli_fetch_array($result))
                                    {
                                      echo $project['skill_name'];
                                    ...
                                    ?>
                                              ...
                                              <div class="alert alert-success">
                                                ...
                                                <i class="fa fa-plus-circle"></i> No Skills added</p>
                            ...
                            <?php
                                 ...
                                 $result = mysqli_query($dbc, "SELECT * FROM selected_kpi WHERE email ='".$row['email']."'"  );
                                 if(mysqli_num_rows($result))
                                 {
                                   while($project= mysqli_fetch_array($result))
                                   {
                                     echo $project['kpi_name'];
                                   ...
                                   ?>
                                             ...
                                             <div class="alert alert-success">
                                               ...
                                               <i class="fa fa-plus-circle"></i> No KPI added</p>
