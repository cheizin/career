...
if(!isset($_SESSION['email']) && empty($_SESSION['email'])) {
   echo 'Kindly Login First or signup to access the Candidates Response';
...
<div class="page-title">
  <div class="container">
    ...
    <h2>Candidates Database and Request For Job Application</h2>
      <p><a href="#" title="Home">Home</a> <i class="ti-angle-double-right"></i> Candidates Database</p>
    </div>
  </div>
</div>
<!-- ======================= End Page Title ===================== -->
...
<section class="padd-top-80 padd-bot-80">
  <div class="container">
            ...
            $sql_query1 =  mysqli_query($dbc,"SELECT * FROM staff_users WHERE access_level ='job-seeker'");
            $number = 1;
      ...
      <div class="col-lg-5 col-xs-12">
        <div class="card card-success card-outline">
          <div class="card-header">
            ...
            $row3 = mysqli_num_rows(mysqli_query($dbc,"SELECT * FROM staff_users WHERE access_level ='job-seeker'"));
          ...
          <table id="example" class="table table-striped table-bordered" style="width:100%">
            ...
            <?php
            $no = 1;
            $sql= mysqli_query($dbc,"SELECT * FROM staff_users WHERE access_level ='job-seeker'");
            ...
            <tr style="cursor: pointer;">
              ...
              <td width="50px"> <?php echo $no++;?>.
                        ...
                        <td  onclick="SelectCandidateModule('<?php echo $row['id'];?>')">
                               <!-- Single Verticle job -->
                              ...
                              <strong>   <span class="pull-left vacancy-no">                <?php  echo $row['fName'];?>,    <?php  echo $row['lName'];?></span> </strong>
                            </br><span class="pull-right vacancy-no">Designation:-<?php  echo $row['currentPosition'];?></span></span>


                                      <span class="com-tagline">
                                           <?php  echo $row['currentPosition'];?></span>
                                        <span class="com-tagline">
                                               at

                                                     <?php  echo $row['companyName'];?>
                                                    </b> <br/>
                                                      Holds a   <?php  echo $row['highestQualification'];?>
                                                             with
    ...
    <strong><i class="fa fa-info-circle"></i> No Candidate has registered in the system</strong>
    </div>
