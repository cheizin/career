...
require_once("controllers/auth/auth.php");
      ...
      if(!isset($_SESSION['email']) && empty($_SESSION['email'])) {
         echo 'Kindly Login First or signup to Add Job';
        ...
        <input type="hidden" value="post-job" name="post-job">
         ...
         <div class="row">
           ...
           <div class="col-md-3 col-sm-6 col-xs-12 m-clear">
             <label><span class="required">*</span>Job Category</label>
             <?php
             ...
             <select class="wide form-control" name="industry_name" data-tags="true" class="select2 form-control" required>
               <option data-display="Select Job Category"></option>';
...
<div class="row">
  ...
  <table id="example" class="table table-striped table-bordered" style="width:100%">
         ...
         <?php
         $no = 1;
          $sql = mysqli_query($dbc,"SELECT * FROM job_posting  ORDER BY id ASC");
         ...
         <tr style="cursor: pointer;">
                      ...
                      <td>
                         ...
                         <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
                           <div class="modal-content">
                             <div class="modal-header">
                               <h5 class="modal-title">Modifying Job Post<strong>: <?php echo $row['job_title'] ;?></strong></h5>
                               <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                 <span aria-hidden="true">&times;</span>
                               </button>
                             </div>
                        ...
                        <td>
                        <a href="#" class="btn btn-link" onclick="CloseJob('<?php echo $row['id'];?>');">
                          Delete
                        </a>
                      </td>
