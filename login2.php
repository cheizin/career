    ...
    <ul class="nav navbar-nav navbar-left" data-in="fadeInDown" data-out="fadeOutUp">
          <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown">Jobs</a>
            <ul class="dropdown-menu animated fadeOutUp">
              ...
              <li><a href="view-job.php">View Jobs</a></li>
            </ul>
          </li>
          <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown">Candidate</a>
            <ul class="dropdown-menu animated fadeOutUp">
              ...
              <li><a href="candidates_database.php">Candidates Database</a></li>
...
<div class="page-title">
  <div class="container">
    <div class="page-caption">
      <h2>Login</h2>
      <p><a href="#" title="Home">Home</a> <?php echo $_POST['id']; ?> <i class="ti-angle-double-right"></i> Login</p>
    </div>
  </div>
</div>
<!-- ======================= End Page Title ===================== -->
      ...
      <div class="row module-panel">
          ...
          <form id="test-login-form" class="mt-4" enctype="multipart/form-data">
              ...
              <div class="form-group"> <span class="custom-checkbox">
                ...
                <label for="4"></label>
                Remember Me </span> <a href="enter_email.php" title="Forget" class="fl-right">Forgot Password?</a>
			  </div>
